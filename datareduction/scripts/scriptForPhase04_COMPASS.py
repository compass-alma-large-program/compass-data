...
tclean(vis=visname, field='BHR71-IRS1',
       ...
       datacolumn='data',
       imagename='oussid.s10_0.BHR71-IRS1_sci.spw25.cube.I.iter2', imsize=[500,
       500], cell=['0.074arcsec'], phasecenter='ICRS 12:01:36.4988 -065.08.49.381', stokes='I', specmode='cube', nchan=3837,
       start='279.0475460151GHz', width='0.2441427MHz', outframe='LSRK',
       ...
       robust=0.5, npixels=0, niter=2000000, threshold=newthreshold, nsigma=0.0,
...
tclean(vis=visname, field='BHR71-IRS1',
       ...
       500], cell=['0.074arcsec'], phasecenter='ICRS 12:01:36.4988 -065.08.49.381', stokes='I', specmode='cube', nchan=3838,
